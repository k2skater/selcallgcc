...
#define LCD_D2	7	//define MCU pin connected to LCD D1
#define LCD_D3	7	//define MCU pin connected to LCD D2
...
void LCDsendCommand(uint8_t);	//forms data ready to send to 74HC164for(i=0;i<5;i++){
				//LCDGotoXY(i,0);
